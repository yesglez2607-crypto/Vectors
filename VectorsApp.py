...
with col1:
    if F1_mag != 0.0:
        ...
        ax.text(-1.85,0.6,r'$ \overrightarrow{F_1} $',fontsize = 25.0, color='darkgreen',fontstyle='oblique',fontfamily='fantasy')  
    if F2_mag !=0.0 and F2_theta != 0.0:    
        ...
        ax.text(-1.5,0.6,r'$ \overrightarrow{F_2} $',fontsize = 25.0, color='red',fontstyle='oblique',fontfamily='fantasy') 
