...
with col1:
    if F1_mag != 0.0:
        ...
        ax.text(500,35,r'$ \overrightarrow{F_1} $',fontsize = 25.0, color='darkgreen',fontstyle='oblique',fontfamily='fantasy',zorder=7) 
    if F2_mag !=0.0 and F2_theta != 0.0:    
        ...
        ax.text(560,35,r'$ \overrightarrow{F_2} $',fontsize = 25.0, color='red',fontstyle='oblique',fontfamily='fantasy',zorder=7) 
    if F3_mag !=0.0 and F3_theta != 0.0:
        ...
        ax.text(683,35,r'$ \overrightarrow{F_3} $',fontsize = 25.0, color='blue',fontstyle='oblique',fontfamily='fantasy',zorder=7,transform=IdentityTransform())
        ax.text(790,35,r'$ \overrightarrow{F_R} $',fontsize = 25.0, color='darkorange',fontstyle='oblique',fontfamily='fantasy',zorder=7,transform=IdentityTransform()) 
    st.pyplot(fig)
