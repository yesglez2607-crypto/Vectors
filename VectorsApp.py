...
with col1:
    if F1_mag != 0.0:
        ...
        ax.text(-1.85,1.5,r'$ \overrightarrow{F_1} $',fontsize = 25.0, color='darkgreen',zorder=7,transform=IdentityTransform())  
        ax.text(500,35,r'$ \overrightarrow{F_1} $',fontsize = 25.0, color='darkgreen') 
    if F2_mag !=0.0 and F2_theta != 0.0:    
        ...
        ax.text(-1.7,1.454,r'$ \overrightarrow{F_2} $',fontsize = 25.0, color='red',zorder=7,transform=IdentityTransform()) 
        ax.text(560,35,r'$ \overrightarrow{F_2} $',fontsize = 25.0, color='red') 
