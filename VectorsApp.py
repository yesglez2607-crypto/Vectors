...
ax.arrow(0,0,Ax,Ay,width=width_l,color='red',length_includes_head=True,animated=True,head_width=5.0)
ax.arrow(Ax,Ay,Bx,By,width=width_l,color='blue',length_includes_head=True,animated=True,head_width=5.0)
ax.arrow(0,0,Cx,Cy,width=width_l,color='green',length_includes_head=True,animated=True,head_width=5.0)
ax.grid()
