...
with col1:
    if F1_mag != 0.0:
        ...
        ax.text(920,50,r'$ \overrightarrow{F_1} $',fontsize = fntz, color='darkgreen',zorder=7,transform=IdentityTransform()) 
    if F2_mag !=0.0 and F2_theta != 0.0:    
        ...
        ax.text(1020,50,r'$ \overrightarrow{F_2} $',fontsize = fntz, color='red',zorder=7,transform=IdentityTransform()) 
    if F3_mag !=0.0 and F3_theta != 0.0:
        ...
        ax.text(1120,50,r'$ \overrightarrow{F_3} $',fontsize = fntz, color='blue',zorder=7,transform=IdentityTransform())
        ax.text(1220,50,r'$ \overrightarrow{F_R} $',fontsize = fntz, color='darkorange',zorder=7,transform=IdentityTransform()) 
    st.pyplot(fig)
