...
with col1:
    if F1_mag != 0.0:
        ...
        ax.text(-1.85,1.5,r'$ \overrightarrow{F_1} $',fontsize = 25.0, color='darkgreen',fontstyle='oblique',fontfamily='fantasy')  
    if F2_mag !=0.0 and F2_theta != 0.0:    
        ...
        ax.text(-1.7,1.454,r'$ \overrightarrow{F_2} $',fontsize = 25.0, color='red',fontstyle='oblique',fontfamily='fantasy') 
    if F3_mag !=0.0 and F3_theta != 0.0:
        ...
        ax.text(-1.47,1.432,r'$ \overrightarrow{F_R} $',fontsize = 25.0, color='darkorange',fontstyle='oblique',fontfamily='fantasy') 
